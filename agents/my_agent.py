...
Uses the hackathon LiteLLM proxy for model access.
...
client = openai.OpenAI(
    api_key=os.getenv("LITELLM_API_KEY", "sk-Q1QGmsIdw1v33-edjyEH-Q"),
...
if __name__ == "__main__":
    if not os.environ.get("LITELLM_API_KEY"):
        print("Set LITELLM_API_KEY first (your virtual key for the LiteLLM proxy).")
